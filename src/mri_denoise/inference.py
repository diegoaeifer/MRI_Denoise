...
from monai.transforms import (
    ...
    SaveImaged, ScaleIntensityRanged, ConcatItemsd
)
...
def build_inference_transforms(cfg):
    ...
    return Compose([
        ...
        ScaleIntensityRangePercentilesd(keys="image", lower=0.05, upper=99.5, b_min=0.0, b_max=1.0, clip=True),
        SpatiallyVaryingNoised(keys="image", spatial_dims=spatial_dims, sigma_range=(0.05, 0.05), multiplier_range=(1.0, 1.0)),
...
def main(args):
    ...
    # Load Network
    model_cfg = {
        "in_channels": 2, "out_channels": 1, "spatial_dims": args.spatial_dims,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--roi_size", nargs='+', type=int, default=[256, 256], help="ROI size for sliding window")

...
def test_dicom_loader_invalid_file(temp_dicom_dir, caplog):
    ...
    assert any("Invalid DICOM file" in msg and "invalid.dcm" in msg for msg in warning_messages), f"Expected warning for invalid DICOM file not found. Logs: {warning_messages}"
